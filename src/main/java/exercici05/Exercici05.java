...
public class Exercici05 {
    ...
    private CentreSalud consulta;

    public Exercici05(){
        consulta = new CentreSalud();
        ...
        Lib.limpiarPantalla();
        System.out.println("PACIENT MAJOR Edat: " + consulta.get(consulta.menorMajor()[1]).calcularEdat());
        System.out.println("PACIENT MENOR Edat: " + consulta.get(consulta.menorMajor()[0]).calcularEdat());
